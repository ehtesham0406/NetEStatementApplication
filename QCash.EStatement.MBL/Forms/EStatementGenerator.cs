...
using QCash.EStatement.MBL.Reports;
...
namespace StatementGenerator
{
    public partial class EStatementGenerator : Form
    {
        ...
        void btnGenerate_Click(object sender, EventArgs e)
        {
            ...
            {
                txtAnalyzer.Invoke(_addText, new object[] { "\n" + System.DateTime.Now.ToString("MMMM dd, yyyy h:mm:tt") + " : Processing Estatement BDT." });//Processing Estatement BDT
                                            ...
                                            if (stmdt.Rows.Count > 0)
                                            {
                                              ...
                                              //  fileName = _fiid + "_" + dtCards.Rows[j]["pan"].ToString().Substring(0, 6) + "_" + stmdt.Rows[0]["Statement_Date"].ToString().Replace('/', '-') + '_' + pdfCount + ".pdf";
                                                ...
                                                for (int i = 0; i < document.Pages.Count; ++i)
                                                {
                                                    ...
                                                    XRect layoutRectangle = new XRect(250 /*X*/ , 195/*Y*/ , page.Width /*Width*/ , font.Height /*Height*/ );
        ...
        private void ProcessStatementUSD(DataTable dtCards)
        {
            ...
            ConStr = new ConnectionStringBuilder(1);
            objProvider = new SqlDbProvider(ConStr.ConnectionString_DBConfig);
            ds = objProvider.ReturnData("select * from statement_USD ORDER BY  CAST( STATEMENTNO as int) ASC", ref reply);
